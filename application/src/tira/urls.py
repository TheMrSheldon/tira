...
urlpatterns = [
    ...
    path('login', views.login, name='login'),       # TODO: remove
    path('logout', views.logout, name='logout'),    # TODO: remove
    ...
    path('tira-admin/upload-dataset/<str:task_id>/<str:dataset_id>/<str:dataset_type>', admin_api.admin_upload_dataset, name='tira-admin-upload-dataset'),
    path('tira-admin/import-irds-dataset/<str:task_id>', admin_api.admin_import_ir_dataset, name='tira-admin-import-irds-dataset'),
