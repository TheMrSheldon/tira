  ...
  methods: {
    ...
    async runSoftware() {
      ...
      if (valid) {
        ...
        post(inject("REST base URL")+`/grpc/${this.task_id}/${this.user_id}/run_execute/docker/${this.selectedDataset}/${this.docker_software_id}/${this.selectedResource}/${reranking_dataset}`, {})
